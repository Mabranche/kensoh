   ...
   <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Marques</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">

                            <li><a href="{{route('brand.create')}}"><i class="fa fa-circle"></i>Ajouter</a></li>
                            <li><a href="{{ route('brand.index')}}"><i class="fa fa-circle"></i>Liste des marques</a></li>
